...
select ename 이름, salary 급여, salary + 300 "인상된 급여"
from employee;
...
--이름, 급여와 부서번호를 출력하되 이름을 오름차순으로 출력하세요. 
...
--14. 담당 업무가 사무원(CLERK) 또는 영업사원(SALESMAN)이며서 급여가 $1600, $950, 또는 $1300 이 아닌 사원의
-- 이름, 담당업무, 급여를 출력하시오. 
...
select ename, job, salary
from employee
where (job = 'CLERK' or 'SALESMAN') and salary not in (1600, 950, 1300);
